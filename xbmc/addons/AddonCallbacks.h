...
typedef void         (*PVRTransferChannelEntry)      (void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const PVR_CHANNEL *chan);
typedef void         (*PVRTransferChannelGroup)      (void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const PVR_CHANNEL_GROUP *group);
typedef void         (*PVRTransferChannelGroupMember)(void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const PVR_CHANNEL_GROUP_MEMBER *member);
typedef void         (*PVRTransferEpgEntry)          (void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const EPG_TAG *epgentry);
typedef void         (*PVRTransferMenuHook)          (void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const PVR_MENUHOOK *hook);
typedef void         (*PVRTransferRecordingEntry)    (void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const PVR_RECORDING *recording);
typedef void         (*PVRTransferTimerEntry)        (void *addonData, const ADDON_HANDLE handle, const PVR_UPDATE_TYPE updateType, const PVR_TIMER *timer);
typedef void         (*PVRRecording)                 (void *addonData, const char *Name, const char *FileName, bool On);//TODO
...
typedef struct CB_PVRLib
{
  ...
  PVRTransferMenuHook           TransferMenuHook;
